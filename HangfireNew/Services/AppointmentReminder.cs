...
namespace HangfireNew.Services
{
    ...
    public class AppointmentReminder : IAppointmentReminder
    {
        ...
        public AppointmentReminder(IOptions<ApiSettings> apiSettings, IOptions<CredentialsStore> credentialsStore, IOptions<ConnectionStrings> connectionstrings, IOptions<JobServiceOptions> jobServiceOptions)
        {
