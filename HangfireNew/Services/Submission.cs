                                    ...
                                    if (response1.IsSuccessStatusCode)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            for (int j = 0; j < SubmitterReceiver.Count; j++)
                                            {
                                                ...
                                                string processFileUrl1 = $"http://localhost:16655/ElectronicSubmission/GetClaimIDsAutoSubmission"; // string processFileUrl1 = $"{ApiAddress}ElectronicSubmission/GetClaimIDsAutoSubmission";
