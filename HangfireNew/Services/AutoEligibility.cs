...
{
    public interface IAutoEligibilityService
    {
        Task MarkNoShowAppointmentsJob();
    }
    public class AutoEligibilityService : IAutoEligibilityService
    {
        private readonly ApiSettings _apiSettings;
        private readonly Dictionary<string, UserCredentials> _userCredentials;
        private readonly HttpClient _httpClient;

        public AutoEligibilityService(IOptions<ApiSettings> apiSettings, IOptions<CredentialsStore> credentialsStore)
        {
